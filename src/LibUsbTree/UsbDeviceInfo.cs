...
{
    public sealed class UsbDeviceInfo : IDisposable
    {
        ...
        {
            if (!SetupDiGetDevicePropertyW(deviceInfoSet, ref deviceInfoData, ref key, out _, buffer, bufSize, out _, 0))
            {
        ...
        internal UsbDeviceInfo(IntPtr deviceInfoSet, SP_DEVINFO_DATA deviceInfoData)
        {
