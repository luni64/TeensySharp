...
TARGET_NAME      := TempMon_TMM
BOARD_ID         := TEENSY_MICROMOD
MCU              := imxrt1062
...
GCC_BASE         := C:\toolchain\Arduino\arduino-1.8.15\hardware\tools\arm\bin
UPL_PJRC_B       := C:\toolchain\Arduino\arduino-1.8.15\hardware\tools
...
FLAGS_LD    := -Wl,--print-memory-usage,--gc-sections,--relax -T$(CORE_BASE)/imxrt1062_mm.ld

LIBS        := -larm_cortexM7lfsp_math -lm -lstdc++

DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=155 -DARDUINO_TEENSY_MICROMOD -DARDUINO=10813
